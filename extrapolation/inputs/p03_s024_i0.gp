...
nf=nfinit(polcyclo(67));R=24571790731379705611183195627352541701833;rho=2502127572434023446853080828220044340974;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^2+'x^65)+(1)*('x^27+'x^40),nf.pol);
