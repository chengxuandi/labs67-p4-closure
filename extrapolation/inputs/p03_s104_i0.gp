...
nf=nfinit(polcyclo(67));R=24210874502693372465947268711975259143669;rho=100938423245381302631902206436202437694;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^6+'x^61)+(1)*('x^15+'x^52),nf.pol);
