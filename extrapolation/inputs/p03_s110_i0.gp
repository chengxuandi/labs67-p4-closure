...
nf=nfinit(polcyclo(67));R=24209977619894851705113889026909868818119;rho=6266716232523826797944554749138739526372;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^6+'x^61)+(1)*('x^25+'x^42),nf.pol);
