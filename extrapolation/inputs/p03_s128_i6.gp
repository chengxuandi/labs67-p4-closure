...
nf=nfinit(polcyclo(67));R=24217248293354660861898331444546950799837;rho=20255346804367869141466639349493105448720;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^8+'x^59)+(1)*('x^20+'x^47),nf.pol);
