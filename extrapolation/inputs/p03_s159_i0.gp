...
nf=nfinit(polcyclo(67));R=24147925091713037895636537771523653384881;rho=1549243164048326775892265230555274810190;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^14+'x^53)+(1)*('x^16+'x^51),nf.pol);
