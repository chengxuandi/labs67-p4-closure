...
nf=nfinit(polcyclo(67));R=24213898224368675384208178366150683540049;rho=687002001964040960144190644582292744314;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^14+'x^53)+(1)*('x^23+'x^44),nf.pol);
