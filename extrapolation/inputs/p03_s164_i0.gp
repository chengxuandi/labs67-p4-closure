...
nf=nfinit(polcyclo(67));R=24147855659094359579409416967504800740511;rho=5410231821316381872026650938763755805591;alpha=Mod(17+(1)*('x^1+'x^66)+(1)*('x^14+'x^53)+(1)*('x^29+'x^38),nf.pol);
